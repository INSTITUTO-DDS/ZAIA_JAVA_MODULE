        ...
        for (int i = 0; i < ctx.getLinhas().length; i++) {
            ...
            while (rs.next()) {
                ...
                if ( !nomeTarefa.equals(nomeTarefaFin) ) {
                    throw new MGEModelException("Esta ação só pode ser executada quando a tarefa do Flow for:<br><b>"+nomeTarefa+"</b><br>A tarefa atual é:<br><b>" + nomeTarefaFin + ".</b>");
                }
                ...
                try {
                    ...
                    String msg = Objects.equals(grupoValidacao, BigDecimal.ONE) && statusComp.contains("AP") ? "Esta opção não pode ser usada com este processo. Favor selecionar outro tipo de ajuste." : "";
