...
public class EncerrarTarefaLegado implements AcaoRotinaJava {
    ...
    public void doAction(ContextoAcao contexto) throws Exception {
        for(int i = 0; i < contexto.getLinhas().length; i++){
            Registro reg = contexto.getLinhas()[i];
            ...
            qryFin.loadSql(EventoFinanceiroFlow.class, "queFinanceirosAnt.sql");
            ...
            while (rs.next()) {
                ...
                String status = "AJ";
                String obs = (String) contexto.getParam("OBS");
                String statusComp = (String) contexto.getParam("STATUS");
    ...
    public void encTarefa(BigDecimal nuFin) throws MGEModelException {
        try {
            ...
            qryTarefas.loadSql(AtualizaStatusFlow.class, "queDadosTarefaAnt.sql");
